...
const dayChartData = [
  // [Open, High, Low, Close]
  { x: new Date(2023, 1, 1, 12, 0, 0), y: [451.98, 493.29, 401.59, 420.85] },
  { x: new Date(2023, 1, 1, 13, 0, 0), y: [353.66, 374.99, 281.35, 320.95] },
  { x: new Date(2023, 1, 1, 14, 0, 0), y: [352.96, 403.78, 351.54, 388.48] },
  { x: new Date(2023, 1, 1, 15, 0, 0), y: [402.54, 462.79, 407.88, 349.24] },
  { x: new Date(2023, 1, 1, 16, 0, 0), y: [449.17, 482.86, 417.7, 491.78] },
  { x: new Date(2023, 1, 1, 17, 0, 0), y: [500.31, 550.35, 480.54, 530.34] },
  { x: new Date(2023, 1, 1, 18, 0, 0), y: [530.25, 600.56, 520.62, 580.56] },
  { x: new Date(2023, 1, 1, 19, 0, 0), y: [580.34, 620.47, 570.68, 600.23] },
  { x: new Date(2023, 1, 1, 20, 0, 0), y: [600.12, 630.89, 590.45, 620.78] },
  { x: new Date(2023, 1, 1, 21, 0, 0), y: [620.5, 650.32, 610.23, 640.12] },
  { x: new Date(2023, 1, 1, 22, 0, 0), y: [640.78, 670.45, 630.56, 660.34] },
  { x: new Date(2023, 1, 1, 23, 0, 0), y: [660.23, 690.12, 650.34, 680.56] },
  { x: new Date(2023, 1, 1, 24, 0, 0), y: [620.45, 720.34, 670.23, 700.12] },
  { x: new Date(2023, 1, 2, 1, 0, 0), y: [700.34, 730.56, 690.45, 710.78] },
  { x: new Date(2023, 1, 2, 2, 0, 0), y: [710.12, 740.23, 700.34, 720.45] },
  { x: new Date(2023, 1, 2, 3, 0, 0), y: [720.45, 750.12, 710.23, 730.34] },
];
