...
const CandlestickChartSection: React.FC = () => {
  ...
  //   colorSet: 'colorSet2', // ToDo: (20250905 - Julian) Candle color set
  //   //   subtitles: [
  //   //     {
  //   //       text: 'Open',
  //   //     },
  ...
  //     },
  //   ],
  //   creditText: '', // ToDo: (20250905 - Julian) 目前無用
  // };

  return <div className="w-full">{/* <CanvasJSChart options={options} /> */}</div>;
};
