...
export enum APIName {
  ...
  GET_BUSINESS_BY_COMPANY_ID = 'GET_BUSINESS_BY_COMPANY_ID',
  GET_BASIC_INFO_BY_COMPANY_ID = 'GET_BASIC_INFO_BY_COMPANY_ID',
...
export enum APIPath {
  ...
  GET_BUSINESS_BY_COMPANY_ID = `${apiPrefix}/companies/:id`,
  GET_BASIC_INFO_BY_COMPANY_ID = `${apiPrefix}/companies/:id/basic`,
...
export const API_CONFIG: Record<IAPIName, IAPIConfig> = {
  ...
  [APIName.GET_BUSINESS_BY_COMPANY_ID]: createAPIConfig({
    name: APIName.GET_BUSINESS_BY_COMPANY_ID,
    method: HttpMethod.GET,
    path: APIPath.GET_BUSINESS_BY_COMPANY_ID,
  }),
  [APIName.GET_BASIC_INFO_BY_COMPANY_ID]: createAPIConfig({
    name: APIName.GET_BASIC_INFO_BY_COMPANY_ID,
    method: HttpMethod.GET,
    path: APIPath.GET_BASIC_INFO_BY_COMPANY_ID,
  }),
